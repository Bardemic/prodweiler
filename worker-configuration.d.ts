/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b9f6506a4ce1329affd1004850b2124b)
// Runtime types generated with workerd@1.20260714.1 2026-07-20 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AI: Ai;
	CLOUDFLARE_ACCOUNT_ID: "e7e3470b3ad5de64d5676db7de0267db";
	CLOUDFLARE_API_TOKEN: string;
	AGENTS: DurableObjectNamespace<import("./src/worker/index").ProdweilerAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "ProdweilerAgent";
	}
